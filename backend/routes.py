...
from timezone_utils import now_utc, to_user_timezone, from_user_timezone, now_in_user_timezone, set_user_timezone
import json
...
async def update_user_timezone(
    ...
    try:
        ...
        offset = timezone_data.get('offset', 0)
        
        # Set the timezone for this user session
...
async def therapy_chat(
    ...
    try:
        ...
        return TherapyChatResponse(response=therapy_response, timestamp=now_utc())
